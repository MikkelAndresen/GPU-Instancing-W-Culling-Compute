...
Varyings LitPassVertexInstanced(Attributes input, uint instanceID : SV_InstanceID)
{
...
ShadowVaryings ShadowPassVertexInstanced(ShadowAttributes input, uint instanceID : SV_InstanceID)
{
